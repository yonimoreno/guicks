...
window.GI = {
  ...
  async load(cb){
    ...
    // ── Per-app merged file: lang/slug/slug-lang-XX.js ──────────────────────
    if(slug){
      const url=base+'lang/'+slug+'/'+slug+'-lang-'+code+'.js';
      ...
      if(code!=='en'){
        const enOk=await this._loadScript(base+'lang/'+slug+'/'+slug+'-lang-en.js');
